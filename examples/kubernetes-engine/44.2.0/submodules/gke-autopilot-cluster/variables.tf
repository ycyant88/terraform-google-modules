...
variable "maintenance_policy" {
  ...
  default = { "daily_maintenance_window" : { "start_time" : "05:00" } }
}
...
variable "node_pool_auto_config" {
  ...
  default = { "node_kubelet_config" : { "insecure_kubelet_readonly_port_enabled" : false } }
}
...
variable "private_cluster_config" {
  ...
  default = { "enable_private_endpoint" : true, "enable_private_nodes" : true, "master_global_access_config" : { "enabled" : true } }
}
