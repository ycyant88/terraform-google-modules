...
output "istio_enabled" {
  value       = module.kubernetes-engine_beta-private-cluster-update-variant.istio_enabled
  description = "Whether Istio is enabled"
}

output "kubernetes_dashboard_enabled" {
  value       = module.kubernetes-engine_beta-private-cluster-update-variant.kubernetes_dashboard_enabled
