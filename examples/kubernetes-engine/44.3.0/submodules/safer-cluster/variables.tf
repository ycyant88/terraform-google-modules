...
variable "cluster_autoscaling" {
  ...
  default = { "auto_repair" : true, "auto_upgrade" : true, "autoscaling_profile" : "BALANCED", "enable_default_compute_class" : false, "enabled" : false, "gpu_resources" : [], "max_cpu_cores" : 0, "max_memory_gb" : 0, "min_cpu_cores" : 0, "min_memory_gb" : 0 }
}
