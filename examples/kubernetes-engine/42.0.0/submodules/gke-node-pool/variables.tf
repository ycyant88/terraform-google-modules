variable "autoscaling" {
  ...
  default = { "max_node_count" : 100, "min_node_count" : 1 }
}
...
variable "management" {
  ...
  default = { "auto_repair" : true, "auto_upgrade" : true }
}
...
variable "node_config" {
  ...
  default = { "disk_size_gb" : 100, "disk_type" : "pd-standard", "image_type" : "COS_CONTAINERD", "kubelet_config" : { "insecure_kubelet_readonly_port_enabled" : false }, "machine_type" : "e2-medium", "workload_metadata_config" : { "mode" : "GKE_METADATA" } }
}
...
variable "timeouts" {
  ...
  default = { "create" : "45m", "delete" : "45m", "update" : "45m" }
}
...
variable "upgrade_settings" {
  ...
  default = { "max_surge" : 1, "max_unavailable" : 0, "strategy" : "SURGE" }
}
