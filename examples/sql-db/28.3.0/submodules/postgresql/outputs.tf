output "additional_user_passwords_map" {
  value       = module.sql-db.additional_user_passwords_map
...
output "apphub_service_uri" {
  value       = module.sql-db.apphub_service_uri
  description = "Service URI in CAIS style to be used by Apphub."
}

output "dns_name" {
  value       = module.sql-db.dns_name
  description = "DNS name of the instance endpoint"
}

output "env_vars" {
  value       = module.sql-db.env_vars
...
output "instance_psc_attachment" {
  value       = module.sql-db.instance_psc_attachment
...
output "replicas_instance_psc_attachments" {
  value       = module.sql-db.replicas_instance_psc_attachments
