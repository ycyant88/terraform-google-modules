...
variable "backup_configuration" {
  ...
  default = { "binary_log_enabled" : null, "enabled" : null, "start_time" : null }
}
...
variable "failover_replica_configuration" {
  ...
  default = { "ca_certificate" : null, "client_certificate" : null, "client_key" : null, "connect_retry_interval" : null, "dump_file_path" : null, "failover_target" : null, "master_heartbeat_period" : null, "password" : null, "ssl_cipher" : null, "username" : null, "verify_server_certificate" : null }
}
