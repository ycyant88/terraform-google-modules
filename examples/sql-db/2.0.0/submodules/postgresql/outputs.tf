...
output "instance_address" {
  value       = module.sql-db_postgresql.instance_address
...
output "private_address" {
  value       = module.sql-db_postgresql.private_address
...
output "replicas_instance_ip_addresses" {
  value       = module.sql-db_postgresql.replicas_instance_ip_addresses
