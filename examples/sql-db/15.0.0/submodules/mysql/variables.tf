...
variable "backup_configuration" {
  ...
  default = { "binary_log_enabled" : false, "enabled" : false, "location" : null, "retained_backups" : null, "retention_unit" : null, "start_time" : null, "transaction_log_retention_days" : null }
}
...
variable "ip_configuration" {
  ...
  default = { "allocated_ip_range" : null, "authorized_networks" : [], "enable_private_path_for_google_cloud_services" : false, "ipv4_enabled" : true, "private_network" : null, "require_ssl" : null }
}
