output "failover-replica_instance_connection_name" {
  value       = module.sql-db.failover-replica_instance_connection_name
...
output "failover-replica_instance_first_ip_address" {
  value       = module.sql-db.failover-replica_instance_first_ip_address
...
output "failover-replica_instance_service_account_email_address" {
  value       = module.sql-db.failover-replica_instance_service_account_email_address
...
output "private_address" {
  value       = module.sql-db.private_address
...
output "read_replica_instance_names" {
  value       = module.sql-db.read_replica_instance_names
  description = "The instance names for the read replica instances"
}

output "replicas_instance_connection_names" {
  value       = module.sql-db.replicas_instance_connection_names
...
output "replicas_instance_first_ip_addresses" {
  value       = module.sql-db.replicas_instance_first_ip_addresses
...
output "replicas_instance_self_links" {
  value       = module.sql-db.replicas_instance_self_links
  description = "The URIs of the replica instances"
}

output "replicas_instance_server_ca_certs" {
  value       = module.sql-db.replicas_instance_server_ca_certs
...
output "replicas_instance_service_account_email_addresses" {
  value       = module.sql-db.replicas_instance_service_account_email_addresses
