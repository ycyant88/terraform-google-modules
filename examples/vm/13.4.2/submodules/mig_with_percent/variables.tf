...
variable "autoscaling_scale_in_control" {
  ...
  default = { "fixed_replicas" : null, "percent_replicas" : null, "time_window_sec" : null }
}
...
variable "health_check" {
  ...
  default = { "check_interval_sec" : 30, "enable_logging" : false, "healthy_threshold" : 1, "host" : "", "initial_delay_sec" : 30, "port" : 80, "proxy_header" : "NONE", "request" : "", "request_path" : "/", "response" : "", "timeout_sec" : 10, "type" : "", "unhealthy_threshold" : 5 }
}
...
variable "mig_timeouts" {
  ...
  default = { "create" : "5m", "delete" : "15m", "update" : "5m" }
}
