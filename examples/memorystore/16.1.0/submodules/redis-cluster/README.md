...
| cluster\_role | The role of the cluster in cross cluster replication. Possible values are: NONE, PRIMARY, SECONDARY | `string` | `null` | no |
...
| shard\_count | Required. Number of shards for the Redis cluster | `number` | `3` | no |
