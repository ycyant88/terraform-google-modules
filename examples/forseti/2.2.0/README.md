...
| forseti\_version | The version of Forseti to install | string | `"v2.17.0"` | no |
...
| storage\_disable\_polling | Whether to disable polling for Storage API | string | `alse"` | no |
