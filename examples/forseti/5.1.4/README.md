...
```bash
git clone --branch modulerelease514 --depth 1 https://github.com/forseti-security/terraform-google-forseti.git
```
...
| forseti\_version | The version of Forseti to install | string | `"v2.24.3"` | no |
